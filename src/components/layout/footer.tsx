          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
            <div className="lg:col-span-5">
              ...
              <p className="mt-4 sm:mt-6 text-slate text-sm sm:text-base leading-relaxed max-w-md">
                TelFixer is jouw betrouwbare partner voor hoogwaardige
                refurbished elektronica. Wij bieden kwalitatief gecontroleerde
                telefoons, laptops en tablets aan tegen aantrekkelijke prijzen,
