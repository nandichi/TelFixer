    ...
    return (
      <div className="w-full">
        ...
        <textarea
          ...
          id={textareaId}
          className={cn(
            'w-full px-4 py-3.5 rounded-xl border-2 transition-all duration-200 resize-y min-h-[120px]',
        ...
        />
        {error && (
          <p id={`${textareaId}-error`} className="mt-2 text-sm text-[#DC2626] flex items-center gap-1.5">
