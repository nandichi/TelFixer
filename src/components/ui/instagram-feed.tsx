...
const DEFAULT_PROFILE_URL = "https://www.instagram.com/telfixer/";
...
export function InstagramFeed({
  ...
  const INSTAGRAM_POSTS =
    posts && posts.length > 0 ? posts : DEFAULT_POSTS;
  const INSTAGRAM_PROFILE_URL = profileUrl || DEFAULT_PROFILE_URL;
  const profileHandle = (() => {
    try {
      const u = new URL(INSTAGRAM_PROFILE_URL);
      const handle = u.pathname.replace(/\//g, "");
      return handle ? `@${handle}` : "@telfixer";
    } catch {
      return "@telfixer";
    }
  })();
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          ...
          >
            ...
            <span className="text-white">{profileHandle}</span>
            <svg
