    ...
    <div className="py-14 sm:py-16 lg:py-24 bg-cream">
      <Container>
        ...
        <div className="max-w-4xl mx-auto space-y-10">
          <section className="bg-white rounded-3xl border border-sand p-5 sm:p-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-sm">
              <div className="p-4 bg-cream rounded-lg">
                <p className="text-muted mb-1">Bedrijfsnaam</p>
                <p className="font-semibold text-soft-black">TelFixer</p>
              </div>
              <div className="p-4 bg-cream rounded-lg">
                <p className="text-muted mb-1">Adres</p>
              ...
              <div className="p-4 bg-cream rounded-lg">
                <p className="text-muted mb-1">Telefoon</p>
                <a
          ...
          <section className="relative overflow-hidden bg-soft-black text-white rounded-3xl p-6 sm:p-10">
            <div className="absolute inset-0" aria-hidden="true">
              <div className="absolute inset-0 bg-gradient-to-br from-primary-dark via-[#04201f] to-[#0c0c0c]" />
              <div className="absolute -top-24 -right-24 w-[320px] h-[320px] rounded-full bg-primary/20 blur-3xl" />
            </div>
            <div className="relative flex flex-col sm:flex-row items-start gap-5">
              <div className="w-12 h-12 rounded-2xl bg-white/10 border border-white/15 flex items-center justify-center shrink-0">
                <Mail className="h-6 w-6 text-copper-light" strokeWidth={1.75} />
              </div>
              <div>
                <h2 className="text-2xl font-display font-bold mb-2">Vragen?</h2>
                ...
                <div className="flex flex-col sm:flex-row flex-wrap gap-3">
                  <Link
                    href="/contact"
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-2xl bg-white text-soft-black font-semibold hover:bg-cream transition-all duration-300 hover:-translate-y-0.5 active:scale-[0.98]"
                  >
                    Contact opnemen
                  </Link>
                  <a
                    href="mailto:info@telfixer.nl"
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-2xl border border-white/25 text-white font-semibold hover:bg-white/10 transition-all duration-300 active:scale-[0.98]"
                  >
                    info@telfixer.nl
                  </a>
                </div>
