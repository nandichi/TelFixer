          ...
          <div className="mt-12 lg:mt-0">
            <div className="bg-white rounded-3xl border border-sand p-8 sticky top-28" style={{ boxShadow: 'var(--shadow-sm)' }}>
              ...
              <div className="mt-8 pt-8 border-t border-sand space-y-3">
                {[
                  { icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', text: '6 maanden garantie' },
                  { icon: 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15', text: '14 dagen bedenktijd' },
